...
<!-- generated with COPASI 4.19 (Build 140) (http://www.copasi.org) at 2018-07-26 08:06:27 UTC -->
...
<COPASI xmlns="http://www.copasi.org/static/schema" versionMajor="4" versionMinor="19" versionDevel="140" copasiSourcesModified="0">
  <Model key="Model_12" name="Rosenbrock(10) function" simulationType="time" timeUnit="s" volumeUnit="ml" areaUnit="m²" lengthUnit="m" quantityUnit="mmol" type="deterministic" avogadroConstant="6.02214179e+023">
    <MiriamAnnotation>
<rdf:RDF
...
<p>First described in: Rosenbrock, H.H. (1960) An automatic method to find the greatest or least value of a function. <i>Comput. J.</i> <b>3</b>:175</p></body>
    ...
    <ListOfModelValues>
      <ModelValue key="ModelValue_33" name="x1" simulationType="fixed">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#ModelValue_33">
    <dcterms:created>
      ...
      <ModelValue key="ModelValue_32" name="x2" simulationType="fixed">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#ModelValue_32">
    <dcterms:created>
      ...
      <ModelValue key="ModelValue_31" name="Rosenbrock(10) function" simulationType="assignment">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#ModelValue_31">
    <dcterms:created>
      ...
      <ModelValue key="ModelValue_30" name="x3" simulationType="fixed">
      </ModelValue>
      <ModelValue key="ModelValue_29" name="x4" simulationType="fixed">
      </ModelValue>
...
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#ModelValue_28">
    <dcterms:created>
      ...
      <ModelValue key="ModelValue_27" name="x6" simulationType="fixed">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#ModelValue_27">
    <dcterms:created>
      ...
      <ModelValue key="ModelValue_26" name="x7" simulationType="fixed">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
...
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#ModelValue_25">
    <dcterms:created>
      ...
      <ModelValue key="ModelValue_24" name="x9" simulationType="fixed">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#ModelValue_24">
    <dcterms:created>
      ...
      <ModelValue key="ModelValue_23" name="x10" simulationType="fixed">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  ...
  <ListOfTasks>
    ...
    <Task key="Task_10" name="Scan" type="scan" scheduled="true" updateModel="false">
      <Report reference="Report_18" target="Rosenbrock10Function.txt" append="1" confirmOverwrite="0"/>
      <Problem>
      ...
      <Problem>
        ...
        <ParameterGroup name="OptimizationItemList">
          <ParameterGroup name="OptimizationItem">
            ...
            <Parameter name="StartValue" type="float" value="5.90742"/>
  ...
  <ListOfPlots>
    <PlotSpecification name="progress of optimization" type="Plot2D" active="0">
