...
<!-- generated with COPASI 4.19 (Build 140) (http://www.copasi.org) at 2018-07-26 08:07:53 UTC -->
...
<COPASI xmlns="http://www.copasi.org/static/schema" versionMajor="4" versionMinor="19" versionDevel="140" copasiSourcesModified="0">
  <Model key="Model_20" name="Sphere function" simulationType="time" timeUnit="s" volumeUnit="ml" areaUnit="m²" lengthUnit="m" quantityUnit="mmol" type="deterministic" avogadroConstant="6.02214179e+023">
    <MiriamAnnotation>
<rdf:RDF
  ...
  <rdf:Description rdf:about="#Model_20">
    ...
    <Comment>
      <body xmlns="http://www.w3.org/1999/xhtml"><h1>Sphere function</h1>
<p>Part of a set of benchmark functions for global optimisation</p>
<ul>
 <li>variables: 3</li>
 <li>interval: [-2.56,5.12] (all variables)</li>
 <li>minimum: (0,0,0)</li>
</ul>
<p>f(x1,x2,x3)=x1<sup>2</sup>+x2<sup>2</sup>+x3<sup>2</sup></p>
<hr />
<p>This is a 3-dimensional convex function (spherical). It is the easiest 3D function to minimize. It is separable, in that each parameter could be minimized independently. It serves as a test case for convergence velocity.</p>
<p>First defined (in this context) by:  De Jong, K. A. (1975) <i>An analysis of the behavior of a class of genetic adaptive systems</i>. PhD Thesis, University of Michigan.</p></body>
    </Comment>
    <ListOfModelValues>
      <ModelValue key="ModelValue_61" name="x1" simulationType="fixed">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#ModelValue_61">
    <dcterms:created>
      ...
      <ModelValue key="ModelValue_60" name="x2" simulationType="fixed">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#ModelValue_60">
    <dcterms:created>
      ...
      <ModelValue key="ModelValue_59" name="Sphere function" simulationType="assignment">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#ModelValue_59">
    <dcterms:created>
      <rdf:Description>
        ...
        <Expression>
          &lt;CN=Root,Model=Sphere function,Vector=Values[x1],Reference=InitialValue>^2+&lt;CN=Root,Model=Sphere function,Vector=Values[x2],Reference=InitialValue>^2+&lt;CN=Root,Model=Sphere function,Vector=Values[x3],Reference=InitialValue>^2
        </Expression>
      </ModelValue>
      <ModelValue key="ModelValue_58" name="x3" simulationType="fixed">
      </ModelValue>
    </ListOfModelValues>
    <ListOfModelParameterSets activeSet="ModelParameterSet_0">
      <ModelParameterSet key="ModelParameterSet_0" name="Initial State">
        <ModelParameterGroup cn="String=Initial Time" type="Group">
          <ModelParameter cn="CN=Root,Model=Sphere function" value="0" type="Model" simulationType="time"/>
        </ModelParameterGroup>
        ...
        <ModelParameterGroup cn="String=Initial Global Quantities" type="Group">
          <ModelParameter cn="CN=Root,Model=Sphere function,Vector=Values[x1]" value="0" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Sphere function,Vector=Values[x2]" value="0" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Sphere function,Vector=Values[Sphere function]" value="0" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Sphere function,Vector=Values[x3]" value="0" type="ModelValue" simulationType="fixed"/>
        </ModelParameterGroup>
  ...
  <ListOfTasks>
    ...
    <Task key="Task_10" name="Scan" type="scan" scheduled="true" updateModel="false">
      <Report reference="Report_8" target="SphereFunction.txt" append="1" confirmOverwrite="0"/>
      <Problem>
    ...
    <Task key="Task_8" name="Optimization" type="optimization" scheduled="false" updateModel="false">
      ...
      <Problem>
        ...
        <ParameterText name="ObjectiveExpression" type="expression">
          &lt;CN=Root,Model=Sphere function,Vector=Values[Sphere function],Reference=InitialValue>
        </ParameterText>
        ...
        <ParameterGroup name="OptimizationItemList">
          <ParameterGroup name="OptimizationItem">
            <Parameter name="LowerBound" type="cn" value="-2.56"/>
            <Parameter name="ObjectCN" type="cn" value="CN=Root,Model=Sphere function,Vector=Values[x1],Reference=InitialValue"/>
            <Parameter name="StartValue" type="float" value="6.40636"/>
            <Parameter name="UpperBound" type="cn" value="5.12"/>
          </ParameterGroup>
          <ParameterGroup name="OptimizationItem">
            <Parameter name="LowerBound" type="cn" value="-2.56"/>
            <Parameter name="ObjectCN" type="cn" value="CN=Root,Model=Sphere function,Vector=Values[x2],Reference=InitialValue"/>
            <Parameter name="StartValue" type="float" value="2.970921949709515"/>
            <Parameter name="UpperBound" type="cn" value="5.12"/>
          </ParameterGroup>
          <ParameterGroup name="OptimizationItem">
            <Parameter name="LowerBound" type="cn" value="-2.56"/>
            <Parameter name="ObjectCN" type="cn" value="CN=Root,Model=Sphere function,Vector=Values[x3],Reference=InitialValue"/>
            <Parameter name="StartValue" type="float" value="0.832124"/>
            <Parameter name="UpperBound" type="cn" value="5.12"/>
          </ParameterGroup>
        </ParameterGroup>
