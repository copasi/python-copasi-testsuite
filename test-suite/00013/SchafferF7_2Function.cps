...
<!-- generated with COPASI 4.19 (Build 140) (http://www.copasi.org) at 2018-07-26 08:06:55 UTC -->
...
<COPASI xmlns="http://www.copasi.org/static/schema" versionMajor="4" versionMinor="19" versionDevel="140" copasiSourcesModified="0">
  <Model key="Model_15" name="Schaffer F7(2) function" simulationType="time" timeUnit="s" volumeUnit="ml" areaUnit="m²" lengthUnit="m" quantityUnit="mmol" type="deterministic" avogadroConstant="6.02214179e+023">
    <MiriamAnnotation>
<rdf:RDF
  ...
  <rdf:Description rdf:about="#Model_15">
    ...
    <Comment>
      <body xmlns="http://www.w3.org/1999/xhtml"><h1>Schaffer F7(2) function</h1>
...
<p>f(x<sub>1</sub>,x<sub>2</sub>)=  (1+ sin(50*
(sqrt(x<sub>1</sub><sup>2</sup>+x<sub>2</sub><sup>2</sup>))<sup>0.2</sup>)<sup>2</sup> * sqrt(sqrt(x<sub>1</sub><sup>2</sup>+x<sub>2</sub><sup>2</sup>))
)<sup>2</sup>
</p><hr />
<p>The Schaffer F7 function is difficult because to reach the global minimum concentric barriers need to be overcome. which are higher closer to the minimum. There are local minima everywhere in the search space. This function is a good test for escaping local minima. This is the 2-dimensional version of the function.</p>
...
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#ModelValue_6">
    <dcterms:created>
      ...
      <ModelValue key="ModelValue_5" name="Schaffer F7(2) function" simulationType="assignment">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#ModelValue_5">
    <dcterms:created>
      <rdf:Description>
        ...
        <Expression>
          ((1+sin(50*sqrt(&lt;CN=Root,Model=Schaffer F7(2) function,Vector=Values[x1],Reference=InitialValue>^2+&lt;CN=Root,Model=Schaffer F7(2) function,Vector=Values[x2],Reference=InitialValue>^2)^0.2))*sqrt(sqrt(&lt;CN=Root,Model=Schaffer F7(2) function,Vector=Values[x1],Reference=InitialValue>^2+&lt;CN=Root,Model=Schaffer F7(2) function,Vector=Values[x2],Reference=InitialValue>^2)))^2
        </Expression>
      </ModelValue>
    </ListOfModelValues>
    <ListOfModelParameterSets activeSet="ModelParameterSet_1">
      <ModelParameterSet key="ModelParameterSet_1" name="Initial State">
        <ModelParameterGroup cn="String=Initial Time" type="Group">
          <ModelParameter cn="CN=Root,Model=Schaffer F7(2) function" value="0" type="Model" simulationType="time"/>
        </ModelParameterGroup>
        ...
        <ModelParameterGroup cn="String=Initial Global Quantities" type="Group">
          <ModelParameter cn="CN=Root,Model=Schaffer F7(2) function,Vector=Values[x1]" value="0" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Schaffer F7(2) function,Vector=Values[x2]" value="0" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Schaffer F7(2) function,Vector=Values[Schaffer F7(2) function]" value="0" type="ModelValue" simulationType="assignment"/>
        </ModelParameterGroup>
  ...
  <ListOfTasks>
    ...
    <Task key="Task_16" name="Scan" type="scan" scheduled="true" updateModel="false">
      <Report reference="Report_19" target="SchafferF7_2Function.txt" append="1" confirmOverwrite="0"/>
      <Problem>
    ...
    <Task key="Task_18" name="Optimization" type="optimization" scheduled="false" updateModel="false">
      ...
      <Problem>
        ...
        <ParameterText name="ObjectiveExpression" type="expression">
          &lt;CN=Root,Model=Schaffer F7(2) function,Vector=Values[Schaffer F7(2) function],Reference=InitialValue>
        </ParameterText>
        ...
        <ParameterGroup name="OptimizationItemList">
          <ParameterGroup name="OptimizationItem">
            ...
            <Parameter name="ObjectCN" type="cn" value="CN=Root,Model=Schaffer F7(2) function,Vector=Values[x1],Reference=InitialValue"/>
            <Parameter name="StartValue" type="float" value="-12.4157"/>
            <Parameter name="UpperBound" type="cn" value="100"/>
          </ParameterGroup>
          <ParameterGroup name="OptimizationItem">
            <Parameter name="LowerBound" type="cn" value="-100"/>
            <Parameter name="ObjectCN" type="cn" value="CN=Root,Model=Schaffer F7(2) function,Vector=Values[x2],Reference=InitialValue"/>
    ...
    <PlotSpecification name="Create New" type="Plot2D" active="1">
      ...
      <ListOfPlotItems>
        <PlotItem name="Values[y].InitialValue/Values[f].InitialValue|Values[x].InitialValue" type="Spectogram">
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Schaffer F7(2) function,Vector=Values[x1],Reference=InitialValue"/>
            <ChannelSpec cn="CN=Root,Model=Schaffer F7(2) function,Vector=Values[x2],Reference=InitialValue"/>
            <ChannelSpec cn="CN=Root,Model=Schaffer F7(2) function,Vector=Values[Schaffer F7(2) function],Reference=InitialValue"/>
          </ListOfChannels>
        </PlotItem>
      </ListOfPlotItems>
    </PlotSpecification>
