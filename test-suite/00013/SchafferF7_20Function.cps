...
<!-- generated with COPASI 4.19 (Build 140) (http://www.copasi.org) at 2018-07-26 08:07:16 UTC -->
...
<COPASI xmlns="http://www.copasi.org/static/schema" versionMajor="4" versionMinor="19" versionDevel="140" copasiSourcesModified="0">
  <Model key="Model_17" name="Schaffer F7(20) function" simulationType="time" timeUnit="s" volumeUnit="ml" areaUnit="m²" lengthUnit="m" quantityUnit="mmol" type="deterministic" avogadroConstant="6.02214179e+023">
    <MiriamAnnotation>
<rdf:RDF
...
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#ModelValue_6">
    <dcterms:created>
      ...
      <ModelValue key="ModelValue_7" name="Schaffer F7(20) function" simulationType="assignment">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#ModelValue_7">
    <dcterms:created>
      ...
      <ModelValue key="ModelValue_22" name="x3" simulationType="fixed">
      </ModelValue>
      <ModelValue key="ModelValue_21" name="x4" simulationType="fixed">
      </ModelValue>
      <ModelValue key="ModelValue_20" name="x5" simulationType="fixed">
      </ModelValue>
      <ModelValue key="ModelValue_19" name="x6" simulationType="fixed">
      </ModelValue>
      <ModelValue key="ModelValue_18" name="x7" simulationType="fixed">
      </ModelValue>
      <ModelValue key="ModelValue_17" name="x8" simulationType="fixed">
      </ModelValue>
      <ModelValue key="ModelValue_16" name="x9" simulationType="fixed">
      </ModelValue>
      <ModelValue key="ModelValue_15" name="x10" simulationType="fixed">
      </ModelValue>
      <ModelValue key="ModelValue_14" name="x11" simulationType="fixed">
      </ModelValue>
      <ModelValue key="ModelValue_13" name="x12" simulationType="fixed">
      </ModelValue>
      <ModelValue key="ModelValue_12" name="x13" simulationType="fixed">
      </ModelValue>
      <ModelValue key="ModelValue_11" name="x14" simulationType="fixed">
      </ModelValue>
      <ModelValue key="ModelValue_10" name="x15" simulationType="fixed">
      </ModelValue>
      <ModelValue key="ModelValue_9" name="x16" simulationType="fixed">
      </ModelValue>
      <ModelValue key="ModelValue_8" name="x17" simulationType="fixed">
      </ModelValue>
      <ModelValue key="ModelValue_3" name="x18" simulationType="fixed">
      </ModelValue>
      <ModelValue key="ModelValue_4" name="x19" simulationType="fixed">
      </ModelValue>
      <ModelValue key="ModelValue_0" name="x20" simulationType="fixed">
      </ModelValue>
    </ListOfModelValues>
  ...
  <ListOfTasks>
    ...
    <Task key="Task_24" name="Scan" type="scan" scheduled="true" updateModel="false">
      <Report reference="Report_17" target="SchafferF7_20Function.txt" append="1" confirmOverwrite="0"/>
      <Problem>
      ...
      <Problem>
        ...
        <ParameterGroup name="OptimizationItemList">
          ...
          <ParameterGroup name="OptimizationItem">
            ...
            <Parameter name="StartValue" type="float" value="-68.46806599005483"/>
            <Parameter name="UpperBound" type="cn" value="100"/>
          </ParameterGroup>
          <ParameterGroup name="OptimizationItem">
            <Parameter name="LowerBound" type="cn" value="-100"/>
