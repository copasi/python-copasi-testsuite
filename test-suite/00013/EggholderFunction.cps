...
<!-- generated with COPASI 4.19 (Build 140) (http://www.copasi.org) at 2018-07-26 07:58:19 UTC -->
...
<COPASI xmlns="http://www.copasi.org/static/schema" versionMajor="4" versionMinor="19" versionDevel="140" copasiSourcesModified="0">
  <Model key="Model_7" name="Eggholder function" simulationType="time" timeUnit="s" volumeUnit="ml" areaUnit="m²" lengthUnit="m" quantityUnit="mmol" type="deterministic" avogadroConstant="6.02214179e+023">
    <MiriamAnnotation>
<rdf:RDF
...
<p>Described in the Global Optimization Benchmarks page <a href="http://infinity77.net/global_optimization/index.html">http://infinity77.net/global_optimization/index.html</a> (accessed Dec 2, 2016).</p>
</body>
    </Comment>
    <ListOfModelValues>
...
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#ModelValue_6">
    <dcterms:created>
      ...
      <ModelValue key="ModelValue_5" name="Eggholder function" simulationType="assignment">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
    ...
    <ListOfModelParameterSets activeSet="ModelParameterSet_1">
      <ModelParameterSet key="ModelParameterSet_1" name="Initial State">
        ...
        <ModelParameterGroup cn="String=Initial Global Quantities" type="Group">
          ...
          <ModelParameter cn="CN=Root,Model=Eggholder function,Vector=Values[Eggholder function]" value="-25.46033718528631" type="ModelValue" simulationType="assignment"/>
        </ModelParameterGroup>
  ...
  <ListOfTasks>
    ...
    <Task key="Task_16" name="Scan" type="scan" scheduled="true" updateModel="false">
      <Report reference="Report_19" target="EggholderFunction.txt" append="1" confirmOverwrite="0"/>
      <Problem>
      ...
      <Problem>
        ...
        <ParameterGroup name="OptimizationItemList">
          ...
          <ParameterGroup name="OptimizationItem">
            ...
            <Parameter name="StartValue" type="float" value="137.8673675078685"/>
            <Parameter name="UpperBound" type="cn" value="512"/>
          </ParameterGroup>
        </ParameterGroup>
