...
<!-- generated with COPASI 4.19 (Build 140) (http://www.copasi.org) at 2018-07-26 08:06:48 UTC -->
...
<COPASI xmlns="http://www.copasi.org/static/schema" versionMajor="4" versionMinor="19" versionDevel="140" copasiSourcesModified="0">
  <Model key="Model_14" name="Schaffer F6 function" simulationType="time" timeUnit="s" volumeUnit="ml" areaUnit="m²" lengthUnit="m" quantityUnit="mmol" type="deterministic" avogadroConstant="6.02214179e+023">
    <MiriamAnnotation>
<rdf:RDF
  ...
  <rdf:Description rdf:about="#Model_14">
    ...
    <Comment>
      <body xmlns="http://www.w3.org/1999/xhtml"><h1>Schaffer F6 function</h1>
...
<p>f(x<sub>1</sub>,x<sub>2</sub>)= 0.5 + (sin(sqrt(x<sub>1</sub><sup>2</sup>-x<sub>2</sub><sup>2</sup>))<sup>2</sup> - 0.5) / (1 + 0.001 (x<sub>1</sub><sup>2</sup> + x<sub>2</sub><sup>2</sup>))<sup>2</sup>
</p><hr />
<p>The Schaffer F6 function is difficult because the global minimum is surrounded by concentric maxima which are higher closer to the minimum. This is a good test for escaping local minima.</p>
<p>Defined in: Schaffer, J.D. (1985) <i>Some experiments in machine learning using vector evaluated genetic algorithms</i> PhD Thesis, Vanderbilt University, Nashville, TN (USA).</p>
    ...
    <ListOfModelValues>
      <ModelValue key="ModelValue_23" name="x1" simulationType="fixed">
        <MiriamAnnotation>
...
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#ModelValue_24">
    <dcterms:created>
      ...
      <ModelValue key="ModelValue_25" name="Schaffer F6 function" simulationType="assignment">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#ModelValue_25">
    <dcterms:created>
      <rdf:Description>
        ...
        <Expression>
          0.5+(sin(sqrt(&lt;CN=Root,Model=Schaffer F6 function,Vector=Values[x1],Reference=InitialValue>^2-&lt;CN=Root,Model=Schaffer F6 function,Vector=Values[x2],Reference=InitialValue>^2))^2-0.5)/(1+0.001*(&lt;CN=Root,Model=Schaffer F6 function,Vector=Values[x1],Reference=InitialValue>^2+&lt;CN=Root,Model=Schaffer F6 function,Vector=Values[x2],Reference=InitialValue>^2))^2
        </Expression>
      </ModelValue>
    </ListOfModelValues>
    <ListOfModelParameterSets activeSet="ModelParameterSet_0">
      <ModelParameterSet key="ModelParameterSet_0" name="Initial State">
        <ModelParameterGroup cn="String=Initial Time" type="Group">
          <ModelParameter cn="CN=Root,Model=Schaffer F6 function" value="0" type="Model" simulationType="time"/>
        </ModelParameterGroup>
        ...
        <ModelParameterGroup cn="String=Initial Global Quantities" type="Group">
          <ModelParameter cn="CN=Root,Model=Schaffer F6 function,Vector=Values[x1]" value="0" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Schaffer F6 function,Vector=Values[x2]" value="0" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Schaffer F6 function,Vector=Values[Schaffer F6 function]" value="0" type="ModelValue" simulationType="assignment"/>
        </ModelParameterGroup>
  ...
  <ListOfTasks>
    ...
    <Task key="Task_2" name="Scan" type="scan" scheduled="true" updateModel="false">
      <Report reference="Report_18" target="SchafferF6Function.txt" append="1" confirmOverwrite="0"/>
      <Problem>
    ...
    <Task key="Task_4" name="Optimization" type="optimization" scheduled="false" updateModel="false">
      ...
      <Problem>
        ...
        <ParameterText name="ObjectiveExpression" type="expression">
          &lt;CN=Root,Model=Schaffer F6 function,Vector=Values[Schaffer F6 function],Reference=InitialValue>
        </ParameterText>
        ...
        <ParameterGroup name="OptimizationItemList">
          <ParameterGroup name="OptimizationItem">
            ...
            <Parameter name="ObjectCN" type="cn" value="CN=Root,Model=Schaffer F6 function,Vector=Values[x1],Reference=InitialValue"/>
            <Parameter name="StartValue" type="float" value="-12.4157"/>
            <Parameter name="UpperBound" type="cn" value="100"/>
          </ParameterGroup>
          <ParameterGroup name="OptimizationItem">
            <Parameter name="LowerBound" type="cn" value="-100"/>
            <Parameter name="ObjectCN" type="cn" value="CN=Root,Model=Schaffer F6 function,Vector=Values[x2],Reference=InitialValue"/>
    ...
    <PlotSpecification name="Create New" type="Plot2D" active="1">
      ...
      <ListOfPlotItems>
        <PlotItem name="Values[y].InitialValue/Values[f].InitialValue|Values[x].InitialValue" type="Spectogram">
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Schaffer F6 function,Vector=Values[x1],Reference=InitialValue"/>
            <ChannelSpec cn="CN=Root,Model=Schaffer F6 function,Vector=Values[x2],Reference=InitialValue"/>
            <ChannelSpec cn="CN=Root,Model=Schaffer F6 function,Vector=Values[Schaffer F6 function],Reference=InitialValue"/>
          </ListOfChannels>
        </PlotItem>
      </ListOfPlotItems>
    </PlotSpecification>
