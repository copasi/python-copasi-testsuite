...
<!-- generated with COPASI 4.19 (Build 140) (http://www.copasi.org) at 2018-07-26 07:58:41 UTC -->
...
<COPASI xmlns="http://www.copasi.org/static/schema" versionMajor="4" versionMinor="19" versionDevel="140" copasiSourcesModified="0">
  <Model key="Model_9" name="Holder table 2 function" simulationType="time" timeUnit="s" volumeUnit="ml" areaUnit="m²" lengthUnit="m" quantityUnit="mmol" type="deterministic" avogadroConstant="6.02214179e+023">
    <MiriamAnnotation>
<rdf:RDF
  ...
  <rdf:Description rdf:about="#Model_9">
    ...
    <Comment>
      <body xmlns="http://www.w3.org/1999/xhtml"><h1>Holder table 2 function</h1>
<p>Part of a set of benchmark functions for global optimisation</p>
<ul>
 <li>variables: 2</li>
 <li>interval: [-10,10] (all variables)</li>
 <li>global minima: (8.05502,9.66459), (-8.05502,9.66459), (8.05502,-9.66459), (-8.05502,-9.66459)</li>
 <li>minimum value: -19.20850</li>
</ul>
<p>f(x<sub>1</sub>,x<sub>2</sub>)=- abs( 
sin(x<sub>1</sub>) cos(x<sub>2</sub>)
exp( 
 abs( 1 - sqrt(x<sub>1</sub><sup>2</sup> + x<sub>2</sub><sup>2</sup>) / &pi; ) 
) )</p>
<hr />
<p>The holder table function has four global minima close to the corners of the search space. In addition it has many other local minima, arranged in a regular pattern. The function is separable so in principle it could be minimized by two independent searches in one direction (each of the parameters).</p>
...
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#ModelValue_6">
    <dcterms:created>
      ...
      <ModelValue key="ModelValue_7" name="Holder table 2 function" simulationType="assignment">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#ModelValue_7">
    <dcterms:created>
      <rdf:Description>
        ...
        <Expression>
          -abs(sin(&lt;CN=Root,Model=Holder table 2 function,Vector=Values[x1],Reference=InitialValue>)*cos(&lt;CN=Root,Model=Holder table 2 function,Vector=Values[x2],Reference=InitialValue>)*exp(abs(1-sqrt(&lt;CN=Root,Model=Holder table 2 function,Vector=Values[x1],Reference=InitialValue>^2+&lt;CN=Root,Model=Holder table 2 function,Vector=Values[x2],Reference=InitialValue>^2)/pi)))
        </Expression>
      </ModelValue>
    </ListOfModelValues>
    <ListOfModelParameterSets activeSet="ModelParameterSet_1">
      <ModelParameterSet key="ModelParameterSet_1" name="Initial State">
        <ModelParameterGroup cn="String=Initial Time" type="Group">
          <ModelParameter cn="CN=Root,Model=Holder table 2 function" value="0" type="Model" simulationType="time"/>
        </ModelParameterGroup>
        ...
        <ModelParameterGroup cn="String=Initial Global Quantities" type="Group">
          <ModelParameter cn="CN=Root,Model=Holder table 2 function,Vector=Values[x1]" value="0" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Holder table 2 function,Vector=Values[x2]" value="0" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Holder table 2 function,Vector=Values[Holder table 2 function]" value="0" type="ModelValue" simulationType="assignment"/>
        </ModelParameterGroup>
  ...
  <ListOfTasks>
    ...
    <Task key="Task_24" name="Scan" type="scan" scheduled="true" updateModel="false">
      <Report reference="Report_17" target="HolderTable2Function.txt" append="1" confirmOverwrite="0"/>
      <Problem>
    ...
    <Task key="Task_22" name="Optimization" type="optimization" scheduled="false" updateModel="false">
      ...
      <Problem>
        ...
        <ParameterText name="ObjectiveExpression" type="expression">
          &lt;CN=Root,Model=Holder table 2 function,Vector=Values[Holder table 2 function],Reference=InitialValue>
        </ParameterText>
        ...
        <ParameterGroup name="OptimizationItemList">
          <ParameterGroup name="OptimizationItem">
            ...
            <Parameter name="ObjectCN" type="cn" value="CN=Root,Model=Holder table 2 function,Vector=Values[x1],Reference=InitialValue"/>
            <Parameter name="StartValue" type="float" value="0.268358"/>
            <Parameter name="UpperBound" type="cn" value="10"/>
          </ParameterGroup>
          <ParameterGroup name="OptimizationItem">
            <Parameter name="LowerBound" type="cn" value="-10"/>
            <Parameter name="ObjectCN" type="cn" value="CN=Root,Model=Holder table 2 function,Vector=Values[x2],Reference=InitialValue"/>
            <Parameter name="StartValue" type="float" value="-0.8880682547781778"/>
            <Parameter name="UpperBound" type="cn" value="10"/>
          </ParameterGroup>
        </ParameterGroup>
  ...
  <ListOfPlots>
    ...
    <PlotSpecification name="Create New" type="Plot2D" active="1">
      ...
      <ListOfPlotItems>
        <PlotItem name="Values[y].InitialValue/Values[f].InitialValue|Values[x].InitialValue" type="Unset">
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Holder table 2 function,Vector=Values[x1],Reference=InitialValue"/>
            <ChannelSpec cn="CN=Root,Model=Holder table 2 function,Vector=Values[x2],Reference=InitialValue"/>
            <ChannelSpec cn="CN=Root,Model=Holder table 2 function,Vector=Values[Holder table 2 function],Reference=InitialValue"/>
          </ListOfChannels>
        </PlotItem>
      </ListOfPlotItems>
    </PlotSpecification>
