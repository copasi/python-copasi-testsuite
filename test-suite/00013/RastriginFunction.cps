...
<!-- generated with COPASI 4.19 (Build 140) (http://www.copasi.org) at 2018-07-26 08:06:13 UTC -->
...
<COPASI xmlns="http://www.copasi.org/static/schema" versionMajor="4" versionMinor="19" versionDevel="140" copasiSourcesModified="0">
  <Model key="Model_11" name="Rastrigin's function" simulationType="time" timeUnit="s" volumeUnit="ml" areaUnit="m²" lengthUnit="m" quantityUnit="mmol" type="deterministic" avogadroConstant="6.02214179e+023">
    <MiriamAnnotation>
<rdf:RDF
  ...
  <rdf:Description rdf:about="#Model_11">
    ...
    <Comment>
      <body xmlns="http://www.w3.org/1999/xhtml"><h1>Rastrigin's function</h1>
...
20 + 
(x<sub>1</sub><sup>2</sup> - 10 cos( 2&amp;amp;amp;pi; x<sub>1</sub>))
+
(x<sub>2</sub><sup>2</sup> - 10 cos( 2&amp;amp;amp;pi; x<sub>2</sub>))
</p>
<hr />
<p>Rastrigin’s function has a large number of local minima (more than 100 in the search space), however they are arranged in a regular fashion with symetry. This function is separable and in principle could be minimized as a set of 2 independent minimizations (one in each coordinate).</p>
<p>Defined in: Rastrigin, L.A. (1974) <i>Systems of extremal control</i> Zinatne, Riga.</p>
</body>
    </Comment>
    <ListOfModelValues>
      <ModelValue key="ModelValue_7" name="x1" simulationType="fixed">
        <MiriamAnnotation>
...
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#ModelValue_6">
    <dcterms:created>
      ...
      <ModelValue key="ModelValue_5" name="Rastrigin's function" simulationType="assignment">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#ModelValue_5">
    <dcterms:created>
      <rdf:Description>
        ...
        <Expression>
          20+(&lt;CN=Root,Model=Rastrigin's function,Vector=Values[x1],Reference=InitialValue>^2-10*cos(2*pi*&lt;CN=Root,Model=Rastrigin's function,Vector=Values[x1],Reference=InitialValue>))+(&lt;CN=Root,Model=Rastrigin's function,Vector=Values[x2],Reference=InitialValue>^2-10*cos(2*pi*&lt;CN=Root,Model=Rastrigin's function,Vector=Values[x2],Reference=InitialValue>))
        </Expression>
      </ModelValue>
    </ListOfModelValues>
    <ListOfModelParameterSets activeSet="ModelParameterSet_1">
      <ModelParameterSet key="ModelParameterSet_1" name="Initial State">
        <ModelParameterGroup cn="String=Initial Time" type="Group">
          <ModelParameter cn="CN=Root,Model=Rastrigin's function" value="0" type="Model" simulationType="time"/>
        </ModelParameterGroup>
        ...
        <ModelParameterGroup cn="String=Initial Global Quantities" type="Group">
          <ModelParameter cn="CN=Root,Model=Rastrigin's function,Vector=Values[x1]" value="0" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Rastrigin's function,Vector=Values[x2]" value="0" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Rastrigin's function,Vector=Values[Rastrigin's function]" value="0" type="ModelValue" simulationType="assignment"/>
        </ModelParameterGroup>
  ...
  <ListOfTasks>
    ...
    <Task key="Task_16" name="Scan" type="scan" scheduled="true" updateModel="false">
      <Report reference="Report_19" target="RastriginFunction.txt" append="1" confirmOverwrite="0"/>
      <Problem>
    ...
    <Task key="Task_18" name="Optimization" type="optimization" scheduled="false" updateModel="false">
      ...
      <Problem>
        ...
        <ParameterText name="ObjectiveExpression" type="expression">
          &lt;CN=Root,Model=Rastrigin's function,Vector=Values[Rastrigin's function],Reference=InitialValue>
        </ParameterText>
        ...
        <ParameterGroup name="OptimizationItemList">
          <ParameterGroup name="OptimizationItem">
            ...
            <Parameter name="ObjectCN" type="cn" value="CN=Root,Model=Rastrigin's function,Vector=Values[x1],Reference=InitialValue"/>
            <Parameter name="StartValue" type="float" value="-1.86597"/>
            <Parameter name="UpperBound" type="cn" value="5.12"/>
          </ParameterGroup>
          <ParameterGroup name="OptimizationItem">
            <Parameter name="LowerBound" type="cn" value="-5.12"/>
            <Parameter name="ObjectCN" type="cn" value="CN=Root,Model=Rastrigin's function,Vector=Values[x2],Reference=InitialValue"/>
            <Parameter name="StartValue" type="float" value="-0.9304612211255499"/>
            <Parameter name="UpperBound" type="cn" value="5.12"/>
          </ParameterGroup>
        </ParameterGroup>
    ...
    <PlotSpecification name="Create New" type="Plot2D" active="1">
      ...
      <ListOfPlotItems>
        <PlotItem name="Values[y].InitialValue/Values[f].InitialValue|Values[x].InitialValue" type="Spectogram">
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Rastrigin's function,Vector=Values[x1],Reference=InitialValue"/>
            <ChannelSpec cn="CN=Root,Model=Rastrigin's function,Vector=Values[x2],Reference=InitialValue"/>
            <ChannelSpec cn="CN=Root,Model=Rastrigin's function,Vector=Values[Rastrigin's function],Reference=InitialValue"/>
          </ListOfChannels>
        </PlotItem>
      </ListOfPlotItems>
    </PlotSpecification>
