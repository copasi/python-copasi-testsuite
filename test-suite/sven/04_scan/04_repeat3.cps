...
<!-- generated with COPASI 4.23 (Build 184) (http://www.copasi.org) at 2018-08-21 09:22:05 UTC -->
...
<rdf:RDF
  ...
  <rdf:Description rdf:about="#Model_1">
    ...
    <ListOfReactions>
      <Reaction key="Reaction_1" name="reaction" reversible="false" fast="false" addNoise="false">
        ...
        <ListOfConstants>
          <Constant key="Parameter_7555" name="v" value="0.1"/>
        </ListOfConstants>
        <KineticLaw function="Function_6" unitType="Default" scalingCompartment="CN=Root,Model=New Model,Vector=Compartments[compartment]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_49">
              <SourceParameter reference="Parameter_7555"/>
            </CallParameter>
          </ListOfCallParameters>
        </KineticLaw>
      </Reaction>
  ...
  <ListOfTasks>
    ...
    <Task key="Task_24" name="Scan" type="scan" scheduled="true" updateModel="false">
      <Report reference="Report_0" target="04_repeat3.txt" append="0" confirmOverwrite="0"/>
      <Problem>
