...
<!-- generated with COPASI 4.23 (Build 184) (http://www.copasi.org) at 2018-08-21 09:52:30 UTC -->
  ...
  <rdf:Description rdf:about="#Reaction_1">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5209" name="v" value="0.2"/>
        </ListOfConstants>
...
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  ...
  <ListOfTasks>
    ...
    <Task key="Task_10" name="Scan" type="scan" scheduled="true" updateModel="false">
      <Report reference="Report_2" target="01_scan_ss.txt" append="0" confirmOverwrite="0"/>
      <Problem>
  ...
  <ListOfReports>
    ...
    <Report key="Report_3" name="Scan Parameters, Time, Concentrations, Volumes, and Global Quantity Values" taskType="scan" separator="&#x09;" precision="6">
      <Comment>
    ...
    <Report key="Report_2" name="Scan Parameters, Time, Concentrations, Volumes, and Global Quantity Values 1" taskType="scan" separator="&#x09;" precision="6">
      <Comment>
        A table of scan parameters, time, variable species concentrations, variable compartment volumes, and variable global quantity values.
      </Comment>
      <Table printTitle="1">
