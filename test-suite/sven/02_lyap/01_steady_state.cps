...
<!-- generated with COPASI 4.24 (Build 197) (http://www.copasi.org) at 2018-08-15 12:16:14 UTC -->
...
<rdf:RDF
  ...
  <rdf:Description rdf:about="#Model_0">
    ...
    <ListOfReactions>
        ...
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=New Model,Vector=Compartments[compartment]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_80">
              <SourceParameter reference="Parameter_7336"/>
            </CallParameter>
      ...
      <Reaction key="Reaction_4" name="reaction_1" reversible="false" fast="false" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Reaction_4">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_7335" name="k1" value="0.2"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=New Model,Vector=Compartments[compartment]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_80">
              <SourceParameter reference="Parameter_7335"/>
            </CallParameter>
            <CallParameter functionParameter="FunctionParameter_81">
  ...
  <ListOfTasks>
    ...
    <Task key="Task_7" name="Lyapunov Exponents" type="lyapunovExponents" scheduled="true" updateModel="false">
      <Report reference="Report_5" target="01_steady_state.txt" append="0" confirmOverwrite="0"/>
      <Problem>
        <Parameter name="ExponentNumber" type="unsignedInteger" value="2"/>
